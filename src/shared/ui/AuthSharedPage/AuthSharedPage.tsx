import styles from './AuthSharedPage.module.scss'

type Props = {
  title: string
}

export const AuthSharedPage = ({ title }: Props) => {
  return (
    <section className={styles.section}>
      ...
      <p className={styles.text}>
        ...
        <br /> Et egestas quis ipsum suspendisse ultrices gravida dictum. Ligula ullamcorper
        ...
        Eget nunc lobortis mattis aliquam. Quam adipiscing vitae proin sagittis nisl rhoncus mattis
